...
const HorizontalStepper2 = () => {
    const [steps, setSteps] = useState([
        { key: 'firstStep', label: 'Create Base Taxonomy', isDone: true, component: firstComponent },
        { key: 'secondStep', label: 'Review Base Taxonomy', isDone: false, component: secondComponent },
        { key: 'thirdStep', label: 'Export', isDone: false, component: thirdComponent },
        { key: 'finalStep', label: 'Summary', isDone: false, component: finalComponent },
    ]);
